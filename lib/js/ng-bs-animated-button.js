  ...
  directive('jpNgBsAnimatedButton', [ '$timeout', function($timeout) {
    return {
      ...
      controller: [ '$scope', function($scope) {
        ...
        $scope.options = {
          buttonDefaultClass: $scope.options.buttonDefaultClass || '',
          buttonSubmittingClass: $scope.options.buttonSubmittingClass || '',
          buttonSuccessClass: $scope.options.buttonSuccessClass || '',
          ...
          buttonSubmittingIcon: $scope.options.buttonSubmittingIcon || 'fa fa-circle-o-notch fa-spin',
